...
const PP = () => {
  return(
    <View>
      <Image source={{ uri: 'https://m.media-amazon.com/images/M/MV5BZGI3ZjYwYTQtNWU5My00MDUwLWE2NmYtNzA0OThiMjYyNTNiXkEyXkFqcGdeQXVyMjMxNTAxNDk@._V1_.jpg' }} style ={styles.pp} />
    </View>
  ) 
};
const Profile = () => {
