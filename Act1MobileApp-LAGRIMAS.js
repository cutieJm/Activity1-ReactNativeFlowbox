...
const PP = () => {
  return(
    <View>
      <Image source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/2/2e/Lee_Jong-suk_March_2018.png' }} style ={styles.pp} />
    </View>
  ) 
};
const Profile = () => {
  const fname = 'John Mark'
  const lname = 'Lagrimas'
  return(
    <View>
